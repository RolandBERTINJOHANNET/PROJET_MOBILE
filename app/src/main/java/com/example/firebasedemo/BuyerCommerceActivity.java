...
public class BuyerCommerceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_commerce);
        ...
        navig.setSelectedItemId(R.id.commerçants);
                    ...
                    for(DataSnapshot child : task.getResult().getChildren()) {
                        ...
                        if(user.isSeller()){
                            ...
                            if (user.isHasProfilePic()) {
                                BuyerCommerceActivity.AsyncTaskDownloadImage asyncTaskDownloadImage
                                        = new BuyerCommerceActivity.AsyncTaskDownloadImage();
