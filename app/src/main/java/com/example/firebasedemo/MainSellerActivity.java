...
public class MainSellerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(MainSellerActivity.this, StartActivity.class));
                finish();
            }
        });
    ...
    private void getBitMapFromURL(String url) {
        MainSellerActivity.AsyncTaskDownloadImage asyncTaskDownloadImage = new MainSellerActivity.AsyncTaskDownloadImage();
        ...
        ref.putFile(imageURI).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(MainSellerActivity.this, "upload successful", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(MainSellerActivity.this, "upload failed", Toast.LENGTH_LONG).show();
                    pd.dismiss();
                }
            }
        });
